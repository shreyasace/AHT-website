      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={cardVariants} className="text-center mb-16">
            ...
            >
              <Beaker className="w-4 h-4 text-aht-orange" />
              <span className="text-sm font-semibold text-aht-orange">Cutting-Edge R&D</span>
            </motion.div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      >
                        <div className="text-2xl font-bold text-aht-orange">{spec.value}</div>
              ...
              >
                <Card className="card-corporate group relative overflow-hidden h-full cursor-pointer">
                  ...
                  <div className="relative mb-5">
                    <motion.div 
                      className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${area.color} flex items-center justify-center text-white shadow-lg`}
                    ...
                    {/* Arrow indicator */}
                    <motion.div
                      className="absolute -right-2 -top-2 w-8 h-8 bg-muted rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                  ...
                  <h3 className="text-xl font-bold text-primary mb-3 group-hover:text-aht-orange transition-colors">
                    {area.title}
                  </h3>
          ...
          >
            <Card className="card-corporate relative overflow-hidden">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div 
                    key={index}
                    className="flex justify-between items-center p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors"
                    whileHover={{ x: 5 }}
                  >
            ...
            <Card className="card-corporate relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-aht-orange/10 to-transparent rounded-bl-full" />
              <h3 className="text-2xl font-bold text-primary mb-6 flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-aht-orange/10 flex items-center justify-center">
                  <Rocket className="w-5 h-5 text-aht-orange" />
                </div>
                Applications
              </h3>
              <ul className="space-y-4">
                {[
                  ...
                  <motion.li 
                    ...
                    whileHover={{ x: 5 }}
                  >
                    <div className="w-2 h-2 bg-gradient-to-r from-aht-orange to-orange-400 rounded-full" />
