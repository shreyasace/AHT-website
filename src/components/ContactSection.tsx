    ...
    <section ref={sectionRef} className="section-corporate relative overflow-hidden bg-primary">
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-10 md:mb-16 px-2">
            {founders.map((founder, index) => (
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-5 sm:p-8 text-white text-center group hover:bg-white/10 transition-all duration-300 relative overflow-hidden">
                  {/* Avatar placeholder */}
                  <motion.div 
                    className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-aht-orange/30 to-primary/30 flex items-center justify-center text-xl sm:text-2xl font-bold text-white border border-white/20"
                    whileHover={{ scale: 1.1, rotate: 5 }}
                  >
                    {founder.name.split(' ').map(n => n[0]).slice(0, 2).join('')}
                  </motion.div>
                  
                  <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">{founder.name}</h4>
                  <div className="text-aht-orange font-semibold mb-3 sm:mb-4 text-sm sm:text-base">{founder.role}</div>
                  
                  <div className="text-xs sm:text-sm text-white/60 mb-4 sm:mb-6 space-y-1">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                    <motion.a 
                      ...
                      className="flex items-center justify-center gap-2 p-2 sm:p-3 rounded-lg sm:rounded-xl bg-white/5 hover:bg-white/10 transition-colors"
                      whileHover={{ scale: 1.02 }}
                    >
                      <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-aht-orange" />
                      <span className="text-white/80 break-all">{founder.email}</span>
                    </motion.a>
                    <motion.a 
                      ...
                      whileHover={{ scale: 1.02 }}
                    >
                      <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-aht-orange" />
